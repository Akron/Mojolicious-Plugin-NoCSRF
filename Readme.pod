...
Mojolicious::Plugin::NoCSRF - Defend CSRF Attacks with Control


=head1 DESCRIPTION

L<Mojolicious::Plugin::NoCSRF> is yet another CSRF attack protection
...
=head2 nocsrf_form_for
  ...
  # In templates:
  %= nocsrf_form_for '/check' => (method => 'POST')
  %= text_input 'example'
  % end

Taghelper for form creation.
Accepts the same parameters as
L<Mojolicious::Plugin::TagHelpers/form_for|form_for>
...
Accepts the same parameters as
L<Mojolicious::Controller/url_for|url_for>
and automatically appends a nocsrf token parameter.
...
therwise a false value is returned.
...
in the underlying HTML document.
  ...
  <meta name="nocsrf" value="g132fgfwedlcuhfh657" id="nocsrf" />
  <!-- ... -->
  <script>
